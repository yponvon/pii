...
|--------------|-----------------------|-----------------------|
| Baseline     | 0.74 / 0.65 / 0.69 / 0.66 | 0.72 / 0.66 / 0.69 / 0.67 |
| Rule-based   | 0.76 / 0.61 / 0.68 / 0.64 | 0.68 / 0.50 / 0.58 / 0.53 |
| **Fine-tuned** | **0.77 / 0.67 / 0.72 / 0.69** | **0.69 / 0.80 / 0.74 / 0.77** |
...
occurrence of a detected value. See `PIPELINE_OVERVIEW.md` for the full
description.
