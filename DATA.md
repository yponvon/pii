...
annotated authentic calls). The synthetic transcripts were **generated by an LLM** not typed by a person, and
...
- **`finetuning/data_prep/generate_synthetic_data.ipynb`** — the **live generator**.
  ...
  corpus was generated the same way in-session; this notebook makes it
